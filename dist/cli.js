...
try {
    ...
    // Try dist path
    try {
        const distPackageJsonPath = join(__dirname$1, '..', '..', 'package.json');
...
const commands = {
    transcribe: () => Promise.resolve().then(function () { return transcribe$1; }),
    summarize: () => Promise.resolve().then(function () { return summarize$1; }),
    infographic: () => Promise.resolve().then(function () { return infographic$1; }),
    process: () => Promise.resolve().then(function () { return processAll$1; }),
};
async function main() {
...
async function generateInfographic(text, apiKey, options) {
...
var infographic$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: infographic
});

async function processAll(args) {
...
var processAll$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: processAll
});
